...
<div class="main-block">
    <div class="day-block">
        <h3>Podsumowanie zamówień dla ${companyData.get("companyName") }
            , ${companyData.get("companyAddress")} ${period} ( ${periodDate} )</h3>
    </div>
</div>
<form action="/admin/orderSummary" method="get">
    <div class="main-block">
        <div class="day-block">
            <div class="day">
                <button id="loadingButton" name="shift" value="1" style="font-weight:  bold">Zmiana 1</button>
            </div>
            <div class="day">
                <button id="loadingButton" name="shift" value="2" style="color: #dfdfdf">Zmiana 2</button>
            </div>
        ...
        <div class="day-block">
            ...
            <div class="day" style="font-size: large; font-weight: bold;">
                Czwartek: ${mealsQtyPerDayFirstShift[3]} dań
            </div>
            <div class="day" style="font-size: large; font-weight: bold;">
                Piątek: ${mealsQtyPerDayFirstShift[4]} dań
            </div>
            <div class="day" style="font-size: large; font-weight: bold;">
                Łącznie: ${mealsQtyPerDayFirstShift[0] + mealsQtyPerDayFirstShift[1] +
                    mealsQtyPerDayFirstShift[2] + mealsQtyPerDayFirstShift[3] + mealsQtyPerDayFirstShift[4]} dań
            </div>
            <div class="day" style="font-size: large; font-weight: bold;">
                Kwota łączna: ${firstShiftPriceSum} zł.
            </div>
