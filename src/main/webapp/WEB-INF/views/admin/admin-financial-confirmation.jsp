...
<form:form method="get" action="/admin/userList">
<div class="main-block">
    <div class="login-row">
        Potwierdzenie wpłaty / wypłaty dla: ${user.firstName} ${user.lastName}, </br>
    ...
    <div class="main-block">
        ...
        <div class="login-row" style="display: flex; flex-direction: row; width: 1000px; justify-content: space-around; align-self: center">
            <div>
                <label>
                    <button id="loadingButton" style="box-shadow: 0px 0px 15px rgb(166,229,135) inset;"> Lista użytkowników </button>
                </label>
            </div>
