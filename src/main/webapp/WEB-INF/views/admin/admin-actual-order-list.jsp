...
<div class="main-block">
    <div class="day-block">
        <table>
            <tr>
                <div class="day">
                    Ilość zamówień: ${actualOrders.size()}
                </div>
            </tr>
            <tr>
                <form action="/admin/actualOrderList/searchDepartment" method="post">
                    <td>
                        <div class="day">
                ...
                <form action="/admin/actualOrderList/searchUsername" method="post">
                    <td>
                        <div class="day">
                            <input type="text" name="searchUsername" placeholder="wszyscy"
                                   style="width: 150px; text-align: center">
                            <button id="loadingButton" type="submit">login</button>
                        </div>
            ...
            <c:forEach var="actualOrder" items="${actualOrders}">
                <tr>
                    ...
                    <td>
                        <div class="day">
                            <div>
                                Login: ${actualOrder.user.username}<br>
                                ID: ${actualOrder.user.userId}<br>
                                    ${actualOrder.user.firstName}
